...
export function InfoModal({ showModal, setShowModal, title, children }: InfoModalProps) {
  return (
    <Modal showModal={showModal} setShowModal={setShowModal}>
      ...
      {/* 优化：增加模态框的宽度和高度，使其在桌面端更大，提升阅读体验 */}
      <div className="w-11/12 max-w-7xl h-5/6 flex flex-col bg-neutral-800/95 backdrop-blur-xl shadow-xl md:rounded-2xl md:border md:border-cyan-50/20">
        ...
        <div className="flex-grow overflow-y-auto text-white p-6 min-h-0">
